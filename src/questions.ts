...

{
    ...
    required: true,
    options: [
      { id: "material_01", label: "Smooth & Polished", imageUrl: "/quiz/q4/material_01.jpg" },
      { id: "material_02", label: "Mixed Textures", imageUrl: "/quiz/q4/material_02.jpg" },
      { id: "material_03", label: "Raw & Organic", imageUrl: "/quiz/q4/material_03.jpg" },
    ],
  },
  {
    id: "space_feel",
    ...
    required: true,
    options: [
      { id: "feel_01", label: "Clean & Streamlined", imageUrl: "/quiz/q5/feel_01.jpg" },
      { id: "feel_02", label: "Balanced & Comfortable", imageUrl: "/quiz/q5/feel_02.jpg" },
      { id: "feel_03", label: "Layered & Collected", imageUrl: "/quiz/q5/feel_03.jpg" },
    ],
  },
