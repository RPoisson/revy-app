...
export const KITCHEN: RoomLayoutSpec = {
  ...
  paletteStrip: { ...PALETTE_STRIP, rect: { x: 0.87, y: 0.1, w: 0.1, h: 0.62 }, count: 4 },
  slots: {
    ...
    shelving: { id: "shelving", label: "", rect: { x: 0.568, y: 0.03, w: 0.14, h: 0.21 }, z: 25 },
    range: { id: "range", label: "", rect: { x: 0.382, y: 0.338, w: 0.14, h: 0.21 }, z: 25 },
    refrigerator: { id: "refrigerator", label: "", rect: { x: 0.569, y: 0.418, w: 0.14, h: 0.21 }, z: 16 },
    ...
    accent_detail: { id: "accent_detail", label: "", rect: { x: 0.586, y: 0.258, w: 0.1, h: 0.15 }, z: 1 },
    ...
    ...Object.fromEntries(["palette_1", "palette_2", "palette_3", "palette_4"].map((id) => [id, p(id, "")])),
  },
};
...
export const PRIMARY_BATHROOM: RoomLayoutSpec = {
  ...
  paletteStrip: { ...PALETTE_STRIP, rect: { x: 0.87, y: 0.1, w: 0.1, h: 0.62 }, count: 4 },
  slots: {
    floor_tile: { id: "floor_tile", label: "", rect: { x: 0.04, y: 0.543, w: 0.2, h: 0.3 }, z: 10, allowOverlap: true },
    countertop: { id: "countertop", label: "", rect: { x: 0.138, y: 0.597, w: 0.2, h: 0.2 }, z: 20, allowOverlap: true },
    main_wall_finish: { id: "main_wall_finish", label: "", rect: { x: 0.041, y: 0.075, w: 0.2, h: 0.4 }, z: 10, allowOverlap: true },
    ...
    freestanding_tub: { id: "freestanding_tub", label: "", rect: { x: 0.749, y: 0.541, w: 0.1, h: 0.15 }, z: 25 },
    shower_glass: { id: "shower_glass", label: "", rect: { x: 0.478, y: 0.075, w: 0.16, h: 0.16 }, z: 25 },
    shower_wall: { id: "shower_wall", label: "", rect: { x: 0.622, y: 0.18, w: 0.2, h: 0.3 }, z: 20 },
    shower_floor: { id: "shower_floor", label: "", rect: { x: 0.709, y: 0.321, w: 0.14, h: 0.21 }, z: 10 },
    sinks: { id: "sinks", label: "", rect: { x: 0.523, y: 0.291, w: 0.08, h: 0.12 }, z: 1 },
    ...
    hardware: { id: "hardware", label: "", rect: { x: 0.26, y: 0.822, w: 0.06, h: 0.09 }, z: 25 },
    towel_hook: { id: "towel_hook", label: "", rect: { x: 0.664, y: 0.72, w: 0.06, h: 0.09 }, z: 16 },
    paper_holder: { id: "paper_holder", label: "", rect: { x: 0.766, y: 0.718, w: 0.06, h: 0.09 }, z: 15 },
    logo_1: { id: "logo_1", label: "", rect: { x: 0.436, y: 0.868, w: 0.32, h: 0.1 }, z: 5 },
    logo_2: { id: "logo_2", label: "", rect: { x: 0.862, y: 0.805, w: 0.12, h: 0.16 }, z: 5 },
    ...Object.fromEntries(["palette_1", "palette_2", "palette_3", "palette_4"].map((id) => [id, p(id, "")])),
  },
...
export const LAUNDRY: RoomLayoutSpec = {
  ...
  paletteStrip: { ...PALETTE_STRIP, rect: { x: 0.87, y: 0.1, w: 0.1, h: 0.62 }, count: 4 },
  slots: {
    tile_flooring: { id: "tile_flooring", label: "", rect: { x: 0.04, y: 0.543, w: 0.2, h: 0.3 }, z: 10, allowOverlap: true },
    countertop_slab: { id: "countertop_slab", label: "", rect: { x: 0.16, y: 0.6, w: 0.2, h: 0.2 }, z: 20, allowOverlap: true },
    main_wall_finish: { id: "main_wall_finish", label: "", rect: { x: 0.041, y: 0.075, w: 0.2, h: 0.4 }, z: 10, allowOverlap: true },
    ...
    backsplash: { id: "backsplash", label: "", rect: { x: 0.629, y: 0.053, w: 0.2, h: 0.3 }, z: 20 },
    ...
    washer: { id: "washer", label: "", rect: { x: 0.726, y: 0.368, w: 0.1, h: 0.15 }, z: 25 },
    dryer: { id: "dryer", label: "", rect: { x: 0.726, y: 0.571, w: 0.1, h: 0.15 }, z: 25 },
    logo_1: { id: "logo_1", label: "", rect: { x: 0.436, y: 0.868, w: 0.32, h: 0.1 }, z: 5 },
    logo_2: { id: "logo_2", label: "", rect: { x: 0.862, y: 0.805, w: 0.12, h: 0.16 }, z: 5 },
    ...Object.fromEntries(["palette_1", "palette_2", "palette_3", "palette_4"].map((id) => [id, p(id, "")])),
  },
...
export const PRIMARY_BATHROOM_NO_TUB: RoomLayoutSpec = {
  ...
  slots: {
    ...
    shower_wall: { id: "shower_wall", label: "Shower Wall", rect: { x: 0.649, y: 0.204, w: 0.20, h: 0.30 }, z: 20 },
    shower_floor: { id: "shower_floor", label: "Shower Floor", rect: { x: 0.708, y: 0.341, w: 0.15, h: 0.225 }, z: 10 },
...
export const GUEST_KIDS_BATH_TUB_SHOWER: RoomLayoutSpec = {
  ...
  paletteStrip: { ...PALETTE_STRIP, rect: { x: 0.87, y: 0.1, w: 0.1, h: 0.62 }, count: 4 },
  slots: {
    floor_tile: { id: "floor_tile", label: "Main Floor Tile", rect: { x: 0.04, y: 0.543, w: 0.2, h: 0.3 }, z: 10, allowOverlap: true },
    countertop: { id: "countertop", label: "Countertop", rect: { x: 0.138, y: 0.597, w: 0.2, h: 0.2 }, z: 20, allowOverlap: true },
    main_wall_finish: { id: "main_wall_finish", label: "Main Wall Finish", rect: { x: 0.041, y: 0.075, w: 0.2, h: 0.4 }, z: 10, allowOverlap: true },
    vanity_cabinet: { id: "vanity_cabinet", label: "Vanity Cabinet", rect: { x: 0.355, y: 0.504, w: 0.28, h: 0.336 }, z: 25 },
    ...
    shower_glass: { id: "shower_glass", label: "Shower Enclosure", rect: { x: 0.478, y: 0.075, w: 0.16, h: 0.16 }, z: 25 },
    tub: { id: "tub", label: "Tub", rect: { x: 0.737, y: 0.349, w: 0.1, h: 0.15 }, z: 25 },
    shower_wall: { id: "shower_wall", label: "Shower Wall", rect: { x: 0.622, y: 0.18, w: 0.2, h: 0.3 }, z: 20 },
    sinks: { id: "sinks", label: "Sinks", rect: { x: 0.523, y: 0.291, w: 0.08, h: 0.12 }, z: 1 },
    faucets: { id: "faucets", label: "Faucets", rect: { x: 0.366, y: 0.248, w: 0.14, h: 0.21 }, z: 1 },
    mirrors: { id: "mirrors", label: "Mirrors", rect: { x: 0.277, y: 0.076, w: 0.14, h: 0.21 }, z: 1 },
